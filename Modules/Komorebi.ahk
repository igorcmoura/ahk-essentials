...
#HotIf komorebiAvailable and komorebiActive and not GetKeyState("Shift", "P")
...
#HotIf komorebiAvailable and komorebiActive and GetKeyState("Shift", "P")
...
#HotIf komorebiAvailable and komorebiActive and GetKeyState("CapsLock", "T")
    1::Komorebic("focus-workspace 0")
    2::Komorebic("focus-workspace 1")
    3::Komorebic("focus-workspace 2")
    4::Komorebic("focus-workspace 3")
